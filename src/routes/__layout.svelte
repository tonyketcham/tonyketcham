...
<div class="flex w-full min-h-screen !md:hidden text-shadow-light dark:text-shadow-dark">
	<div class="m-auto">
		<Sidebar />
	</div>
</div>
<div class="relative w-full font-mono text-shadow-light dark:text-shadow-dark">
	<a
		href="#main-content"
